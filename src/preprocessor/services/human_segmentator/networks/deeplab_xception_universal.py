...
from . import deeplab_xception, deeplab_xception_synBN, gcn
...
class deeplab_xception_transfer_basemodel_savememory(deeplab_xception.DeepLabv3_plus):
    ...
    def top_forward(
        self, input, adj1_target=None, adj2_source=None, adj3_transfer=None
    ):
...
class deeplab_xception_transfer_basemodel_savememory_synbn(
    ...
    def __init__(
        ...
        super(deeplab_xception_transfer_basemodel_savememory_synbn, self).__init__(
            nInputChannels=nInputChannels,
            n_classes=n_classes,
            os=os,
        )
...
class deeplab_xception_end2end_3d(deeplab_xception_transfer_basemodel_savememory):
    def __init__(
        ...
        super(deeplab_xception_end2end_3d, self).__init__(
            nInputChannels=nInputChannels,
            n_classes=n_classes,
            os=os,
        )
        ...
        self.source_graph_2_fea = gcn.Graph_to_Featuremaps_savemem(
            input_channels=input_channels,
            output_channels=out_channels,
            hidden_layers=hidden_layers,
            nodes=source_classes,
        )
        self.source_skip_conv = nn.Sequential(
        ...
        ### middle
        self.middle_featuremap_2_graph = gcn.Featuremaps_to_Graph(
            input_channels=input_channels,
            hidden_layers=hidden_layers,
        ...
        self.middle_graph_2_fea = gcn.Graph_to_Featuremaps_savemem(
            input_channels=input_channels,
            output_channels=out_channels,
            hidden_layers=hidden_layers,
            nodes=n_classes,
        )
        self.middle_skip_conv = nn.Sequential(
            *[nn.Conv2d(input_channels, input_channels, kernel_size=1), nn.ReLU(True)]
        )

        ### multi transpose
        self.transpose_graph_source2target = gcn.Graph_trans(
        ...
        self.transpose_graph_target2source = gcn.Graph_trans(
            in_features=hidden_layers,
            out_features=hidden_layers,
            adj=transfer_graph,
            begin_nodes=n_classes,
            end_nodes=source_classes,
        )

        self.transpose_graph_middle2source = gcn.Graph_trans(
            in_features=hidden_layers,
            out_features=hidden_layers,
            adj=transfer_graph,
        ...
        self.transpose_graph_middle2target = gcn.Graph_trans(
            in_features=hidden_layers,
            out_features=hidden_layers,
            adj=transfer_graph,
            begin_nodes=middle_classes,
        ...
        self.transpose_graph_source2middle = gcn.Graph_trans(
            in_features=hidden_layers,
            out_features=hidden_layers,
            adj=transfer_graph,
            begin_nodes=source_classes,
            end_nodes=middle_classes,
        )
        self.transpose_graph_target2middle = gcn.Graph_trans(
            in_features=hidden_layers,
            out_features=hidden_layers,
            adj=transfer_graph,
            begin_nodes=n_classes,
    ...
    def top_forward(
        ...
        adj1_target=None,
        adj2_source=None,
        adj3_transfer_s2t=None,
        adj3_transfer_t2s=None,
        adj4_middle=None,
        adj5_transfer_s2m=None,
        adj6_transfer_t2m=None,
        adj5_transfer_m2s=None,
        adj6_transfer_m2t=None,
    ):
        x, low_level_features = self.xception_features(input)
        # print(x.size())
        x1 = self.aspp1(x)
        ...
        target_graph1 = self.target_graph_conv1.forward(
            target_graph, adj=adj1_target, relu=True
        )
        middle_graph1 = self.target_graph_conv1.forward(
            middle_graph, adj=adj4_middle, relu=True
        )

        # source 2 target & middle
        source_2_target_graph1_v5 = self.transpose_graph_source2target.forward(
            source_graph1, adj=adj3_transfer_s2t, relu=True
        )
        source_2_middle_graph1_v5 = self.transpose_graph_source2middle.forward(
            source_graph1, adj=adj5_transfer_s2m, relu=True
        )
        # target 2 source & middle
        target_2_source_graph1_v5 = self.transpose_graph_target2source.forward(
            target_graph1, adj=adj3_transfer_t2s, relu=True
        )
        target_2_middle_graph1_v5 = self.transpose_graph_target2middle.forward(
            target_graph1, adj=adj6_transfer_t2m, relu=True
        )
        # middle 2 source & target
        middle_2_source_graph1_v5 = self.transpose_graph_middle2source.forward(
            middle_graph1, adj=adj5_transfer_m2s, relu=True
        )
        middle_2_target_graph1_v5 = self.transpose_graph_middle2target.forward(
            middle_graph1, adj=adj6_transfer_m2t, relu=True
        )
        ...
        source_graph1 = torch.cat(
            (
                source_graph1,
                target_2_source_graph1,
                target_2_source_graph1_v5,
                middle_2_source_graph1,
                middle_2_source_graph1_v5,
            ),
            dim=-1,
        )
        ...
        target_graph1 = torch.cat(
            (
                target_graph1,
                source_2_target_graph1,
                source_2_target_graph1_v5,
                middle_2_target_graph1,
                middle_2_target_graph1_v5,
            ),
            dim=-1,
        )
        target_graph1 = self.fc_graph_target.forward(target_graph1, relu=True)
        # middle
        middle_graph1 = torch.cat(
            (
                middle_graph1,
                source_2_middle_graph1,
                source_2_middle_graph1_v5,
                target_2_middle_graph1,
                target_2_middle_graph1_v5,
            ),
            dim=-1,
        )
        ...
        ### seconde task
        source_graph2 = self.source_graph_conv1.forward(
            source_graph1, adj=adj2_source, relu=True
        )
        target_graph2 = self.target_graph_conv1.forward(
            target_graph1, adj=adj1_target, relu=True
        )
        middle_graph2 = self.target_graph_conv1.forward(
            middle_graph1, adj=adj4_middle, relu=True
        )

        # source 2 target & middle
        source_2_target_graph2_v5 = self.transpose_graph_source2target.forward(
            source_graph2, adj=adj3_transfer_s2t, relu=True
        )
        source_2_middle_graph2_v5 = self.transpose_graph_source2middle.forward(
            source_graph2, adj=adj5_transfer_s2m, relu=True
        )
        # target 2 source & middle
        target_2_source_graph2_v5 = self.transpose_graph_target2source.forward(
            target_graph2, adj=adj3_transfer_t2s, relu=True
        )
        target_2_middle_graph2_v5 = self.transpose_graph_target2middle.forward(
            target_graph2, adj=adj6_transfer_t2m, relu=True
        )
        # middle 2 source & target
        middle_2_source_graph2_v5 = self.transpose_graph_middle2source.forward(
            middle_graph2, adj=adj5_transfer_m2s, relu=True
        )
        middle_2_target_graph2_v5 = self.transpose_graph_middle2target.forward(
            middle_graph2, adj=adj6_transfer_m2t, relu=True
        )
        # source 2 middle target
        ...
        source_graph2 = torch.cat(
            (
                source_graph2,
                target_2_source_graph2,
                target_2_source_graph2_v5,
                middle_2_source_graph2,
                middle_2_source_graph2_v5,
            ),
            dim=-1,
        )
        ...
        target_graph2 = torch.cat(
            (
                target_graph2,
                source_2_target_graph2,
                source_2_target_graph2_v5,
                middle_2_target_graph2,
                middle_2_target_graph2_v5,
            ),
            dim=-1,
        )
        target_graph2 = self.fc_graph_target.forward(target_graph2, relu=True)
        # middle
        middle_graph2 = torch.cat(
            (
                middle_graph2,
                source_2_middle_graph2,
                source_2_middle_graph2_v5,
                target_2_middle_graph2,
                target_2_middle_graph2_v5,
            ),
            dim=-1,
        )
        ...
        ### third task
        source_graph3 = self.source_graph_conv1.forward(
            source_graph2, adj=adj2_source, relu=True
        )
        target_graph3 = self.target_graph_conv1.forward(
            target_graph2, adj=adj1_target, relu=True
        )
        middle_graph3 = self.target_graph_conv1.forward(
            middle_graph2, adj=adj4_middle, relu=True
        )

        # source 2 target & middle
        source_2_target_graph3_v5 = self.transpose_graph_source2target.forward(
            source_graph3, adj=adj3_transfer_s2t, relu=True
        )
        source_2_middle_graph3_v5 = self.transpose_graph_source2middle.forward(
            source_graph3, adj=adj5_transfer_s2m, relu=True
        )
        # target 2 source & middle
        target_2_source_graph3_v5 = self.transpose_graph_target2source.forward(
            target_graph3, adj=adj3_transfer_t2s, relu=True
        )
        target_2_middle_graph3_v5 = self.transpose_graph_target2middle.forward(
            target_graph3, adj=adj6_transfer_t2m, relu=True
        )
        # middle 2 source & target
        middle_2_source_graph3_v5 = self.transpose_graph_middle2source.forward(
            middle_graph3, adj=adj5_transfer_m2s, relu=True
        )
        middle_2_target_graph3_v5 = self.transpose_graph_middle2target.forward(
            middle_graph3, adj=adj6_transfer_m2t, relu=True
        )
        # source 2 middle target
        ...
        source_graph3 = torch.cat(
            (
                source_graph3,
                target_2_source_graph3,
                target_2_source_graph3_v5,
                middle_2_source_graph3,
                middle_2_source_graph3_v5,
            ),
            dim=-1,
        )
        ...
        target_graph3 = torch.cat(
            (
                target_graph3,
                source_2_target_graph3,
                source_2_target_graph3_v5,
                middle_2_target_graph3,
        ...
        # middle
        middle_graph3 = torch.cat(
            (
                middle_graph3,
                source_2_middle_graph3,
                source_2_middle_graph3_v5,
                target_2_middle_graph3,
                target_2_middle_graph3_v5,
            ),
            dim=-1,
        )
    ...
    def forward(
        ...
        if input_source is None and input_target is not None and input_middle is None:
            ...
            source_graph, target_graph, middle_graph, x = self.top_forward(
                input,
                adj1_target=adj1_target,
            ...
            target_x = F.upsample(
                target_x, size=input.size()[2:], mode="bilinear", align_corners=True
            )
        ...
        if input_source is not None and input_target is None and input_middle is None:
            ...
            source_x = F.upsample(
                source_x, size=input.size()[2:], mode="bilinear", align_corners=True
            )
        ...
        if input_middle is not None and input_source is None and input_target is None:
            ...
            middle_x = F.upsample(
                middle_x, size=input.size()[2:], mode="bilinear", align_corners=True
            )
            return None, None, middle_x


class deeplab_xception_end2end_3d_synbn(
    ...
    def __init__(
        ...
        super(deeplab_xception_end2end_3d_synbn, self).__init__(
            nInputChannels=nInputChannels,
            n_classes=n_classes,
            os=os,
        )
