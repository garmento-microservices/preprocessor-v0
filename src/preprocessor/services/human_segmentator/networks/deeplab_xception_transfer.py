...
class deeplab_xception_transfer_basemodel_synBN(deeplab_xception_synBN.DeepLabv3_plus):
    def __init__(
        ...
        super(deeplab_xception_transfer_basemodel_synBN, self).__init__(
            nInputChannels=nInputChannels,
            n_classes=n_classes,
            os=os,
        )
...
class deeplab_xception_transfer_basemodel_synBN_savememory(
    ...
    def __init__(
        ...
        super(deeplab_xception_transfer_basemodel_synBN_savememory, self).__init__(
            nInputChannels=nInputChannels,
            n_classes=n_classes,
            os=os,
        )
...
class deeplab_xception_transfer_projection_synBN_savemem(
    ...
    def __init__(
        ...
        super(deeplab_xception_transfer_projection_synBN_savemem, self).__init__(
            nInputChannels=nInputChannels,
            n_classes=n_classes,
            os=os,
            input_channels=input_channels,
